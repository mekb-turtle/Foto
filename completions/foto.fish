...
complete -c foto -s p -l position -d "Sets the window position: x,y" -x
complete -c foto -s s -l size -d "Sets the window size: w,h" -x
complete -c foto -s b -l background -d "Sets the background color: r,g,b" -x
